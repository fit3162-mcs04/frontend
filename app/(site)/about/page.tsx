...
export const metadata: Metadata = {
  ...
  description:
    "Learn about our team and our mission to analyze genetic stroke risk using AI technology",
};
...
export default function AboutPage() {
  ...
  const projectFeatures = [
    ...
    },
    {
      ...
      description:
        "Users can easily upload genetic data in CSV format for quick and secure analysis",
    },
    {
      id: 3,
      ...
      description:
        "Designed as an academic project to demonstrate the potential of AI in personalized healthcare",
    },
  ];
      ...
      <main className="container mx-auto max-w-6xl px-4 py-16">
            ...
            <div className="relative rounded-xl border border-blue-100 bg-white/70 px-8 py-6 shadow-lg backdrop-blur-sm">
              <p className="text-xl leading-relaxed">
                ...
                <span className="relative mx-1 inline-block">
                  <span className="relative z-10 font-semibold text-indigo-700">
                    Monash University
                  </span>
                ...
                assessment. Our interdisciplinary team combines expertise in
                data science, software engineering, and healthcare informatics
                to create a tool that could help in early risk identification.
              </p>
            </div>
          </div>
          ...
          <div className="mx-auto max-w-4xl overflow-hidden rounded-2xl bg-white shadow-xl">
            ...
            <div className="space-y-6 p-8 md:p-10">
              <p className="text-gray-700 text-lg leading-relaxed first-letter:float-left first-letter:mr-1 first-letter:font-bold first-letter:text-4xl first-letter:text-indigo-600">
                Welcome to our academic project site, where we're exploring the
                intersection of genetic data analysis and healthcare. As a team
                of four Monash University students, we're developing a platform
                that demonstrates how machine learning can be applied to genetic
                data to estimate stroke risk factors.
              </p>
              ...
              <div className="flex items-start space-x-4 rounded-lg border-blue-500 border-l-4 bg-blue-50 p-4">
                ...
                <p className="text-gray-700">
                  Our application analyzes CSV files containing specific genetic
                  markers associated with ischemic stroke risk. By processing
                  this data through our machine learning model, we aim to
                  provide users with insights into potential risk factors while
                  highlighting the possibilities of AI in personalized medicine.
                </p>
              </div>

              <p className="text-gray-700 text-lg leading-relaxed">
                This project represents our culminating work for{" "}
                <span className="font-semibold text-indigo-600">FIT3162</span>,
                where we've applied concepts from data science, software
                engineering, and UI/UX design to create a functional prototype
                that addresses a significant healthcare challenge.
              </p>
              ...
              <div className="mt-8 rounded-lg border-orange-500 border-l-4 bg-gradient-to-r from-red-50 to-orange-50 p-5">
                <p className="flex items-start font-medium">
                  ...
                  <span>
                    ...
                    demonstration purposes only. The results and analysis
                    provided should not be considered medical advice or a
          ...
          <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-4">
            {teamMembers.map((member) => (
              ...
              >
                ...
                <h3 className="mb-1 text-center font-semibold text-xl">
                  {member.name}
                </h3>
        ...
        <section className="mb-20 rounded-xl bg-gradient-to-r from-indigo-50 to-blue-50 p-8">
          ...
          <div className="mx-auto max-w-3xl space-y-4 text-center text-lg">
            <p>
              We aim to demonstrate how technological innovation can contribute
              to preventative healthcare by making complex genetic information
              more accessible and actionable.
            </p>
            <p>
              By creating this prototype, we hope to spark discussions about the
              future of personalized medicine and inspire further research at
